...
def get_arguments():
	...
	parser.add_argument('-r', '--record-counterfactuals', action='store_true',
	                    help='Store counterfactual pairs for causal analysis')
	parser.add_argument('-a', '--active-iterations', type=int, default=10, help='Active Learning Iterations')
	parser.add_argument('-q', '--class_influence', default=None, type=int,
	                    help='Index of the the target class for causal analysis')
